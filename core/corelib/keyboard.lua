...
local function onWidgetKeyDown(widget, keyCode, keyboardModifiers)
  ...
  local callback = widget.boundAloneKeyDownCombos[g_keyboard.determineKeyComboDescription(keyCode, KeyboardNoModifier)]
  signalcall(callback, widget, keyCode)
  callback = widget.boundKeyDownCombos[g_keyboard.determineKeyComboDescription(keyCode, keyboardModifiers)]
...
local function onWidgetKeyPress(widget, keyCode, keyboardModifiers, autoRepeatTicks)
  if keyCode == KeyUnknown then return false end
  local callback = widget.boundKeyPressCombos[g_keyboard.determineKeyComboDescription(keyCode, keyboardModifiers)]
